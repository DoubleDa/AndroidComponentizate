package com.dyx.aca.co.order.adapter;
 ...
 * Function：
 */
public class OrderAdapter extends RecyclerView.Adapter<OrderAdapter.IndexViewHolder> {
    private Context m;
    private List<IndexBean.DataEntity> mDatas;
    private LayoutInflater mLayoutInflater;
    private OnItemClickListener OnItemClickListener;

    public OrderAdapter(Context m, List<IndexBean.DataEntity> mDatas) {
        this.m = m;
        this.mDatas = mDatas;
    ...
    public IndexViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = mLayoutInflater.inflate(R.layout.co_order_item_index, parent, false);
